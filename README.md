...
layer0+layer1 paths expect 25 trainable tensors; the layer0-layer3 bf16 SFT
resume path expects 49 trainable tensors and still excludes the tied embedding
by design.
