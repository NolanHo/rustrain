...
pub(crate) struct QwenLoraSmokeSummary {
    ...
    pub(crate) rank: i64,
    pub(crate) alpha: f64,
    pub(crate) zero_lora_max_delta: f64,
    pub(crate) nonzero_lora_max_delta: f64,
    pub(crate) reload_max_delta: f64,
    pub(crate) trainable_tensors: Vec<String>,
}

#[derive(Debug, Serialize)]
pub(crate) struct QwenLoraTrainSmokeSummary {
    pub(crate) model_path: String,
    pub(crate) fixture: String,
    pub(crate) adapter_output: String,
    pub(crate) target_layers: Vec<usize>,
