...
pub(crate) struct QwenTpAttentionShardWeights<'a> {
    ...
    pub(crate) q_bias: &'a Tensor,
    pub(crate) k_proj: &'a Tensor,
    pub(crate) k_bias: &'a Tensor,
    pub(crate) v_proj: &'a Tensor,
    pub(crate) v_bias: &'a Tensor,
...
#[derive(Debug, Serialize)]
pub(crate) struct QwenDpGradientRankSummary {
    pub(crate) rank: usize,
    pub(crate) world_size: usize,
    pub(crate) local_sequence_count: usize,
    pub(crate) tensor_count: usize,
