...
- JSONL SFT trainer summaries/logs expose `streaming_index_cache_path`,
  ...
  `data.min_instruction_chars`, optional `data.max_instruction_chars`,
  optional `data.min_input_chars`, optional `data.max_input_chars`, optional
  `data.min_system_chars`, optional
  ...
  filtering or response substring/dedupe policy, source weighting policy,
