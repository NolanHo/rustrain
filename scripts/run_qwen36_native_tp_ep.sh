...
case "$mode" in
    ...
    pp-train-smoke)
        ...
        ;;
    *)
    echo "usage: $0 [local-smoke|smoke|sequence-parallel-smoke|gpu-metadata-smoke|tri-smoke|tri-replicated-smoke|ep-smoke|ep-bench|bench|pp-cp-comm-smoke|pp-train-smoke]" >&2
        exit 2
        ;;
esac
