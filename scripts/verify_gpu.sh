...
remote_run env RUSTRAIN_QWEN_SESSION_SINGLE_SFT_CONFIG=configs/qwen_session_single_layers07_sft_bf16.toml RUSTRAIN_EXPECTED_QWEN_TRAINABLE_TENSORS=98 bash scripts/verify_qwen_session_single_sft_resume.sh
